...
describe('taddy.macro', () => {
    ...
    test('should transform with style, dynamic variables and className', async () => {
        expect(
            ...
            import "@taddy/babel-plugin/cache/j5kqa5/1sso9tc.taddy.css";
    ...
    test('should omit invalid values', async () => {
        expect(
            ...
            "import { css } from "@taddy/core";
            import "@taddy/babel-plugin/cache/j5kqa5/1pwnj73.taddy.css";
    ...
    test('should process at rules', async () => {
        expect(
            ...
            "import { css } from "@taddy/core";
            import "@taddy/babel-plugin/cache/j5kqa5/ys50qh.taddy.css";
    ...
    test('should process at rules in combination with dynamic rules', async () => {
        expect(
            ...
            import "@taddy/babel-plugin/cache/j5kqa5/1qmg9uk.taddy.css";
            const colors = ['violet', 'pink'];
            export default css({
              "_1kgt43": "_-t7a17f",
